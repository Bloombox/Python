...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='proximity',
  syntax='proto3',
  serialized_pb=_b('\n\x1fproximity/BluetoothBeacon.proto\x12\tproximity\x1a\x12geo/Location.proto\x1a\x16temporal/Instant.proto\"\xa8\x01\n\x0f\x42luetoothBeacon\x12\x0c\n\x04uuid\x18\x01 \x01(\t\x12\r\n\x05major\x18\x02 \x01(\r\x12\r\n\x05minor\x18\x03 \x01(\r\x12\x1f\n\x04seen\x18\x04 \x01(\x0b\x32\x11.temporal.Instant\x12\x1f\n\x08location\x18\x05 \x01(\x0b\x32\r.geo.Location\x12\'\n\x08\x61\x63\x63uracy\x18\x06 \x01(\x0b\x32\x15.geo.LocationAccuracyB\"\n\x1cio.bloombox.schema.proximityH\x01P\x01\x62\x06proto3')
  ,
...
_BLUETOOTHBEACON = _descriptor.Descriptor(
  ...
  full_name='proximity.BluetoothBeacon',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='uuid', full_name='proximity.BluetoothBeacon.uuid', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='major', full_name='proximity.BluetoothBeacon.major', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='minor', full_name='proximity.BluetoothBeacon.minor', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='seen', full_name='proximity.BluetoothBeacon.seen', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='location', full_name='proximity.BluetoothBeacon.location', index=4,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='accuracy', full_name='proximity.BluetoothBeacon.accuracy', index=5,
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('\n\034io.bloombox.schema.proximityH\001P\001'))
