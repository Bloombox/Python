...
_SCOPE = _descriptor.Descriptor(
  name='Scope',
  full_name='analytics.Scope',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='partner', full_name='analytics.Scope.partner', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='commercial', full_name='analytics.Scope.commercial', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='order', full_name='analytics.Scope.order', index=2,
