...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='security',
  syntax='proto3',
  serialized_pb=_b('\n\x1asecurity/DeviceToken.proto\x12\x08security\x1a\x13\x64\x65vice/Device.proto\x1a\x16temporal/Instant.proto\x1a\x18security/AuthToken.proto\"\x98\x01\n\x0b\x44\x65viceToken\x12\"\n\x05token\x18\x01 \x01(\x0b\x32\x13.security.AuthToken\x12\x1e\n\x06\x64\x65vice\x18\x02 \x01(\x0b\x32\x0e.device.Device\x12!\n\x06issued\x18\x03 \x01(\x0b\x32\x11.temporal.Instant\x12\"\n\x07\x65xpires\x18\x04 \x01(\x0b\x32\x11.temporal.InstantB!\n\x1bio.bloombox.schema.securityH\x01P\x01\x62\x06proto3')
  ,
...
_DEVICETOKEN = _descriptor.Descriptor(
  name='DeviceToken',
  full_name='security.DeviceToken',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='token', full_name='security.DeviceToken.token', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='device', full_name='security.DeviceToken.device', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='issued', full_name='security.DeviceToken.issued', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='expires', full_name='security.DeviceToken.expires', index=3,
