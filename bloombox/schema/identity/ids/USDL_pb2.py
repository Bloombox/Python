...
_USDLFIELDVALUE = _descriptor.Descriptor(
  name='USDLFieldValue',
  full_name='identity.ids.USDLFieldValue',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='field', full_name='identity.ids.USDLFieldValue.field', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='value', full_name='identity.ids.USDLFieldValue.value', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='raw_value', full_name='identity.ids.USDLFieldValue.raw_value', index=2,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='data', full_name='identity.ids.USDLFieldValue.data',
...
_USDL = _descriptor.Descriptor(
  name='USDL',
  full_name='identity.ids.USDL',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='barcode', full_name='identity.ids.USDL.barcode', index=0,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\200@\001')), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='magstripe', full_name='identity.ids.USDL.magstripe', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\200@\001')), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='jurisdiction', full_name='identity.ids.USDL.jurisdiction', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='identification_card', full_name='identity.ids.USDL.identification_card', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='fields', full_name='identity.ids.USDL.fields', index=4,
