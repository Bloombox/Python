...
# source: telemetry/v1beta4/GenericEventstream_Beta4.proto
...
_EVENTS = _descriptor.Descriptor(
  name='Events',
  full_name='bloombox.tables.telemetry.v1beta4.Events',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='uuid', full_name='bloombox.tables.telemetry.v1beta4.Events.uuid', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='timing', full_name='bloombox.tables.telemetry.v1beta4.Events.timing', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='actors', full_name='bloombox.tables.telemetry.v1beta4.Events.actors', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='context', full_name='bloombox.tables.telemetry.v1beta4.Events.context', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='payload', full_name='bloombox.tables.telemetry.v1beta4.Events.payload', index=4,
...
_RAWSTREAM = _descriptor.Descriptor(
  name='RawStream',
  full_name='bloombox.tables.telemetry.v1beta4.RawStream',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='uuid', full_name='bloombox.tables.telemetry.v1beta4.RawStream.uuid', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\360?\001\212@\"Event UUID. Generated upon ingest.')), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='timing', full_name='bloombox.tables.telemetry.v1beta4.RawStream.timing', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\360?\001\212@ZTimestamps related to this event, or, the subject event\'s temporal positioning parameters.')), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='raw', full_name='bloombox.tables.telemetry.v1beta4.RawStream.raw', index=2,
...
_SESSIONS = _descriptor.Descriptor(
  name='Sessions',
  full_name='bloombox.tables.telemetry.v1beta4.Sessions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='bloombox.tables.telemetry.v1beta4.Sessions.id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='stats', full_name='bloombox.tables.telemetry.v1beta4.Sessions.stats', index=1,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
Events = _reflection.GeneratedProtocolMessageType('Events', (_message.Message,), dict(
  DESCRIPTOR = _EVENTS,
  __module__ = 'telemetry.v1beta4.GenericEventstream_Beta4_pb2'
  # @@protoc_insertion_point(class_scope:bloombox.tables.telemetry.v1beta4.Events)
  ))
...
RawStream = _reflection.GeneratedProtocolMessageType('RawStream', (_message.Message,), dict(
  ...
  __module__ = 'telemetry.v1beta4.GenericEventstream_Beta4_pb2'
  # @@protoc_insertion_point(class_scope:bloombox.tables.telemetry.v1beta4.RawStream)
  ))
...
Sessions = _reflection.GeneratedProtocolMessageType('Sessions', (_message.Message,), dict(
  ...
  __module__ = 'telemetry.v1beta4.GenericEventstream_Beta4_pb2'
  # @@protoc_insertion_point(class_scope:bloombox.tables.telemetry.v1beta4.Sessions)
  ))
_sym_db.RegisterMessage(Sessions)


DESCRIPTOR.has_options = True
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('\n+io.bloombox.schema.tables.telemetry.v1beta4B\030GenericEventstream_Beta4H\001P\000\370\001\001'))
