...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='media',
  syntax='proto3',
  serialized_pb=_b('\n\x15media/MediaType.proto\x12\x05media\x1a\x0e\x62q_field.proto\"\xd6\x03\n\tMediaType\x12h\n\x04kind\x18\x01 \x01(\x0e\x32\x15.media.MediaType.KindBC\x8a@@Specifies the generic kind of media being described or attached.\x12[\n\nimage_type\x18\x65 \x01(\x0b\x32\x10.media.ImageTypeB3\x8a@0Specifies content for an image-based media item.H\x00\x12\x64\n\rdocument_type\x18\xc9\x01 \x01(\x0b\x32\x13.media.DocumentTypeB5\x8a@2Specifies content for a document-based media item.H\x00\x12[\n\nvideo_type\x18\xad\x02 \x01(\x0b\x32\x10.media.VideoTypeB2\x8a@/Specifies content for a video-based media item.H\x00\"4\n\x04Kind\x12\x08\n\x04LINK\x10\x00\x12\t\n\x05IMAGE\x10\x01\x12\x0c\n\x08\x44OCUMENT\x10\x02\x12\t\n\x05VIDEO\x10\x03\x42\t\n\x07\x63ontent\"\xad\x01\n\tImageType\x12\x65\n\x04kind\x18\x01 \x01(\x0e\x32\x1a.media.ImageType.ImageKindB;\x8a@8Specifies the format of the attached or described image.\"9\n\tImageKind\x12\x07\n\x03PNG\x10\x00\x12\x07\n\x03JPG\x10\x01\x12\x07\n\x03GIF\x10\x02\x12\x07\n\x03SVG\x10\x03\x12\x08\n\x04WEBP\x10\x04\"\x8e\x02\n\x0c\x44ocumentType\x12n\n\x04kind\x18\x01 \x01(\x0e\x32 .media.DocumentType.DocumentKindB>\x8a@;Specifies the kind of document being attached or described.\x12T\n\ncompressed\x18\x02 \x01(\x08\x42@\x8a@=Specifies whether the attached document is compressed or not.\"8\n\x0c\x44ocumentKind\x12\x07\n\x03TXT\x10\x00\x12\x08\n\x04HTML\x10\x01\x12\x07\n\x03PDF\x10\x02\x12\x0c\n\x08MARKDOWN\x10\x03\"\x9a\x01\n\tVideoType\x12\x65\n\x04kind\x18\x01 \x01(\x0e\x32\x1a.media.VideoType.VideoKindB;\x8a@8Specifies the kind of video being attached or described.\"&\n\tVideoKind\x12\x07\n\x03MP4\x10\x00\x12\x07\n\x03\x46LV\x10\x01\x12\x07\n\x03HLS\x10\x02\x42\x30\n\x18io.bloombox.schema.mediaB\rMediaItemTypeH\x01P\x01\xf8\x01\x01\x62\x06proto3')
  ,
...
_MEDIATYPE_KIND = _descriptor.EnumDescriptor(
  name='Kind',
  full_name='media.MediaType.Kind',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_IMAGETYPE_IMAGEKIND = _descriptor.EnumDescriptor(
  name='ImageKind',
  full_name='media.ImageType.ImageKind',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_DOCUMENTTYPE_DOCUMENTKIND = _descriptor.EnumDescriptor(
  name='DocumentKind',
  full_name='media.DocumentType.DocumentKind',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_VIDEOTYPE_VIDEOKIND = _descriptor.EnumDescriptor(
  name='VideoKind',
  full_name='media.VideoType.VideoKind',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_MEDIATYPE = _descriptor.Descriptor(
  name='MediaType',
  full_name='media.MediaType',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='kind', full_name='media.MediaType.kind', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='image_type', full_name='media.MediaType.image_type', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='document_type', full_name='media.MediaType.document_type', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='video_type', full_name='media.MediaType.video_type', index=3,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='content', full_name='media.MediaType.content',
...
_IMAGETYPE = _descriptor.Descriptor(
  name='ImageType',
  full_name='media.ImageType',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='kind', full_name='media.ImageType.kind', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DOCUMENTTYPE = _descriptor.Descriptor(
  name='DocumentType',
  full_name='media.DocumentType',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='kind', full_name='media.DocumentType.kind', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='compressed', full_name='media.DocumentType.compressed', index=1,
...
_VIDEOTYPE = _descriptor.Descriptor(
  name='VideoType',
  full_name='media.VideoType',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='kind', full_name='media.VideoType.kind', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
ImageType = _reflection.GeneratedProtocolMessageType('ImageType', (_message.Message,), dict(
  ...
  __module__ = 'media.MediaType_pb2'
  # @@protoc_insertion_point(class_scope:media.ImageType)
  ))
