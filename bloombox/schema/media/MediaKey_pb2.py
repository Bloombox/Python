...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='media',
  syntax='proto3',
  serialized_pb=_b('\n\x14media/MediaKey.proto\x12\x05media\x1a\x0e\x62q_field.proto\"9\n\x08MediaKey\x12-\n\x02id\x18\x01 \x01(\tB!\x8a@\x1eUnique ID for this media item.B/\n\x18io.bloombox.schema.mediaB\x0cMediaItemKeyH\x01P\x01\xf8\x01\x01\x62\x06proto3')
  ,
...
_MEDIAKEY = _descriptor.Descriptor(
  name='MediaKey',
  full_name='media.MediaKey',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='media.MediaKey.id', index=0,
