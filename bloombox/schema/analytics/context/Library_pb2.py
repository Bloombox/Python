...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_pb=_b('\n\x1f\x61nalytics/context/Library.proto\x12\x11\x61nalytics.context\x1a\x0e\x62q_field.proto\x1a\x15structs/Version.proto\"\xc6\x02\n\rDeviceLibrary\x12O\n\x07variant\x18\x01 \x01(\tB>\xf0?\x01\x8a@8Variant name of the library being used to transmit data.\x12o\n\x07version\x18\x02 \x01(\x0b\x32\x14.structs.VersionSpecBH\xf0?\x01\x8a@BVersion specification for the library being used to transmit data.\x12s\n\x06\x63lient\x18\x03 \x01(\x0e\x32\x1c.analytics.context.APIClientBE\x8a@BSpecifies which internal Bloombox library sent this event, if any.*C\n\tAPIClient\x12\x10\n\x0cUNIDENTIFIED\x10\x00\x12\x0f\n\x0bJAVA_SCRIPT\x10\x01\x12\t\n\x05SWIFT\x10\x02\x12\x08\n\x04JAVA\x10\x03\x42=\n$io.bloombox.schema.telemetry.contextB\x0eLibraryContextH\x01P\x00\xf8\x01\x01\x62\x06proto3')
  ,
  dependencies=[bq__field__pb2.DESCRIPTOR,structs_dot_Version__pb2.DESCRIPTOR,])

_APICLIENT = _descriptor.EnumDescriptor(
  name='APIClient',
  full_name='analytics.context.APIClient',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_DEVICELIBRARY = _descriptor.Descriptor(
  name='DeviceLibrary',
  full_name='analytics.context.DeviceLibrary',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='variant', full_name='analytics.context.DeviceLibrary.variant', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='version', full_name='analytics.context.DeviceLibrary.version', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='client', full_name='analytics.context.DeviceLibrary.client', index=2,
