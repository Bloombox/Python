...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='services.devices.v1beta1',
  syntax='proto3',
  serialized_pb=_b('\n*devices/v1beta1/DevicesService_Beta1.proto\x12\x18services.devices.v1beta1\x1a\x1cservices/ServiceStatus.proto\x1a\x1cgoogle/api/annotations.proto\"i\n\x10\x44\x65viceAssignment\x12\x0f\n\x07partner\x18\x01 \x01(\t\x12\x10\n\x08location\x18\x02 \x01(\t\x12\x32\n\x04role\x18\x03 \x01(\x0e\x32$.services.devices.v1beta1.DeviceRole\"r\n\x10\x44\x65viceActivation\x12\x0c\n\x04uuid\x18\x01 \x01(\t\x12\x10\n\x08hostname\x18\x02 \x01(\t\x12>\n\nassignment\x18\x03 \x01(\x0b\x32*.services.devices.v1beta1.DeviceAssignment\"\xc7\x01\n\x04Ping\x1a\t\n\x07Request\x1a\x33\n\x08Response\x12\'\n\x06status\x18\x01 \x01(\x0e\x32\x17.services.ServiceStatus\x1a\x7f\n\tOperation\x12\x37\n\x07request\x18\x01 \x01(\x0b\x32&.services.devices.v1beta1.Ping.Request\x12\x39\n\x08response\x18\x02 \x01(\x0b\x32\'.services.devices.v1beta1.Ping.Response\"\xdb\x02\n\nActivation\x1a.\n\x07Request\x12\x0e\n\x06serial\x18\x01 \x01(\t\x12\x13\n\x0b\x66ingerprint\x18\x02 \x01(\t\x1a\x8e\x01\n\x08Response\x12\x0e\n\x06\x61\x63tive\x18\x01 \x01(\x08\x12\x34\n\x05\x65rror\x18\x02 \x01(\x0e\x32%.services.devices.v1beta1.DeviceError\x12<\n\x08manifest\x18\x03 \x01(\x0b\x32*.services.devices.v1beta1.DeviceActivation\x1a\x8b\x01\n\tOperation\x12=\n\x07request\x18\x01 \x01(\x0b\x32,.services.devices.v1beta1.Activation.Request\x12?\n\x08response\x18\x02 \x01(\x0b\x32-.services.devices.v1beta1.Activation.Response*p\n\x0b\x44\x65viceError\x12\x0c\n\x08NO_ERROR\x10\x00\x12\x12\n\x0eINVALID_SERIAL\x10\x01\x12\x14\n\x10\x44\x45VICE_NOT_FOUND\x10\x02\x12\x12\n\x0eINTERNAL_ERROR\x10\x03\x12\x15\n\x11\x44\x45VICE_UNASSIGNED\x10\x04*=\n\nDeviceRole\x12\x0e\n\nUNASSIGNED\x10\x00\x12\x06\n\x02TV\x10\x01\x12\x0b\n\x07\x43HECKIN\x10\x02\x12\n\n\x06\x42\x45\x41\x43ON\x10\x03\x32\xce\x02\n\x07\x44\x65vices\x12v\n\x04Ping\x12&.services.devices.v1beta1.Ping.Request\x1a\'.services.devices.v1beta1.Ping.Response\"\x1d\x82\xd3\xe4\x93\x02\x17\x12\x15/devices/v1beta1/ping\x12\xca\x01\n\x08\x41\x63tivate\x12,.services.devices.v1beta1.Activation.Request\x1a-.services.devices.v1beta1.Activation.Response\"a\x82\xd3\xe4\x93\x02[\")/devices/v1beta1/{serial}/device:activate:\x01*Z+\x12)/devices/v1beta1/{serial}/device:activateB1\n+io.bloombox.schema.services.devices.v1beta1H\x01P\x01\x62\x06proto3')
  ,
...
_DEVICEERROR = _descriptor.EnumDescriptor(
  name='DeviceError',
  full_name='services.devices.v1beta1.DeviceError',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_DEVICEROLE = _descriptor.EnumDescriptor(
  name='DeviceRole',
  full_name='services.devices.v1beta1.DeviceRole',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_DEVICEASSIGNMENT = _descriptor.Descriptor(
  ...
  full_name='services.devices.v1beta1.DeviceAssignment',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='partner', full_name='services.devices.v1beta1.DeviceAssignment.partner', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='location', full_name='services.devices.v1beta1.DeviceAssignment.location', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='role', full_name='services.devices.v1beta1.DeviceAssignment.role', index=2,
...
_DEVICEACTIVATION = _descriptor.Descriptor(
  ...
  full_name='services.devices.v1beta1.DeviceActivation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='uuid', full_name='services.devices.v1beta1.DeviceActivation.uuid', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='hostname', full_name='services.devices.v1beta1.DeviceActivation.hostname', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='assignment', full_name='services.devices.v1beta1.DeviceActivation.assignment', index=2,
...
_PING_REQUEST = _descriptor.Descriptor(
  name='Request',
  full_name='services.devices.v1beta1.Ping.Request',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_PING_RESPONSE = _descriptor.Descriptor(
  name='Response',
  full_name='services.devices.v1beta1.Ping.Response',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='status', full_name='services.devices.v1beta1.Ping.Response.status', index=0,
...
_PING_OPERATION = _descriptor.Descriptor(
  name='Operation',
  full_name='services.devices.v1beta1.Ping.Operation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='request', full_name='services.devices.v1beta1.Ping.Operation.request', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='response', full_name='services.devices.v1beta1.Ping.Operation.response', index=1,
...
_PING = _descriptor.Descriptor(
  name='Ping',
  full_name='services.devices.v1beta1.Ping',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_ACTIVATION_REQUEST = _descriptor.Descriptor(
  name='Request',
  full_name='services.devices.v1beta1.Activation.Request',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='serial', full_name='services.devices.v1beta1.Activation.Request.serial', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='fingerprint', full_name='services.devices.v1beta1.Activation.Request.fingerprint', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ACTIVATION_RESPONSE = _descriptor.Descriptor(
  name='Response',
  full_name='services.devices.v1beta1.Activation.Response',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='active', full_name='services.devices.v1beta1.Activation.Response.active', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='error', full_name='services.devices.v1beta1.Activation.Response.error', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='manifest', full_name='services.devices.v1beta1.Activation.Response.manifest', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ACTIVATION_OPERATION = _descriptor.Descriptor(
  name='Operation',
  full_name='services.devices.v1beta1.Activation.Operation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='request', full_name='services.devices.v1beta1.Activation.Operation.request', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='response', full_name='services.devices.v1beta1.Activation.Operation.response', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ACTIVATION = _descriptor.Descriptor(
  name='Activation',
  full_name='services.devices.v1beta1.Activation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
Ping = _reflection.GeneratedProtocolMessageType('Ping', (_message.Message,), dict(
  ...
  Request = _reflection.GeneratedProtocolMessageType('Request', (_message.Message,), dict(
    ...
    __module__ = 'devices.v1beta1.DevicesService_Beta1_pb2'
    # @@protoc_insertion_point(class_scope:services.devices.v1beta1.Ping.Request)
    ))
  ,
  ...
  Response = _reflection.GeneratedProtocolMessageType('Response', (_message.Message,), dict(
    ...
    __module__ = 'devices.v1beta1.DevicesService_Beta1_pb2'
    # @@protoc_insertion_point(class_scope:services.devices.v1beta1.Ping.Response)
    ))
  ,
  ...
  Operation = _reflection.GeneratedProtocolMessageType('Operation', (_message.Message,), dict(
    ...
    __module__ = 'devices.v1beta1.DevicesService_Beta1_pb2'
    # @@protoc_insertion_point(class_scope:services.devices.v1beta1.Ping.Operation)
    ))
  ,
  DESCRIPTOR = _PING,
  __module__ = 'devices.v1beta1.DevicesService_Beta1_pb2'
  # @@protoc_insertion_point(class_scope:services.devices.v1beta1.Ping)
  ))
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('\n+io.bloombox.schema.services.devices.v1beta1H\001P\001'))

_DEVICES = _descriptor.ServiceDescriptor(
  name='Devices',
  full_name='services.devices.v1beta1.Devices',
  file=DESCRIPTOR,
  index=0,
  options=None,
  ...
  _descriptor.MethodDescriptor(
    name='Ping',
    full_name='services.devices.v1beta1.Devices.Ping',
    index=0,
  ...
  _descriptor.MethodDescriptor(
    name='Activate',
    full_name='services.devices.v1beta1.Devices.Activate',
    index=1,
    containing_service=None,
