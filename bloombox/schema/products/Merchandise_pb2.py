...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='products',
  syntax='proto3',
  serialized_pb=_b('\n\x1aproducts/Merchandise.proto\x12\x08products\x1a\x15\x62\x61se/ProductKey.proto\x1a\x1c\x63ontent/ProductContent.proto\"\xa9\x01\n\x0bMerchandise\x12\x1d\n\x03key\x18\x01 \x01(\x0b\x32\x10.base.ProductKey\x12\'\n\x04type\x18\x02 \x01(\x0e\x32\x19.products.MerchandiseType\x12(\n\x05\x66lags\x18\x03 \x03(\x0e\x32\x19.products.MerchandiseFlag\x12(\n\x07product\x18\x04 \x01(\x0b\x32\x17.content.ProductContent*g\n\x0fMerchandiseType\x12\x1b\n\x17UNSPECIFIED_MERCHANDISE\x10\x00\x12\x0c\n\x08\x43LOTHING\x10\x01\x12\r\n\tGLASSWARE\x10\x02\x12\r\n\tCONTAINER\x10\x03\x12\x0b\n\x07LIGHTER\x10\x04*M\n\x0fMerchandiseFlag\x12\x18\n\x14NO_MERCHANDISE_FLAGS\x10\x00\x12\x10\n\x0cMEDICAL_ONLY\x10\x01\x12\x0e\n\nBRAND_SWAG\x10\x02\x42\x37\n\x1aio.bloombox.schema.productB\x12MerchandiseProductH\x01P\x00\xf8\x01\x01\x62\x06proto3')
  ,
...
_MERCHANDISETYPE = _descriptor.EnumDescriptor(
  ...
  full_name='products.MerchandiseType',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_MERCHANDISEFLAG = _descriptor.EnumDescriptor(
  ...
  full_name='products.MerchandiseFlag',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_MERCHANDISE = _descriptor.Descriptor(
  name='Merchandise',
  full_name='products.Merchandise',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='products.Merchandise.key', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='type', full_name='products.Merchandise.type', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='flags', full_name='products.Merchandise.flags', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='product', full_name='products.Merchandise.product', index=3,
...
Merchandise = _reflection.GeneratedProtocolMessageType('Merchandise', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:products.Merchandise)
  ))
_sym_db.RegisterMessage(Merchandise)


DESCRIPTOR.has_options = True
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('\n\032io.bloombox.schema.productB\022MerchandiseProductH\001P\000\370\001\001'))
