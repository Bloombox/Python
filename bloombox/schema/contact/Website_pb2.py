...
_WEBSITE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='uri', full_name='contact.Website.uri', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='title', full_name='contact.Website.title', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='icon', full_name='contact.Website.icon', index=2,
