...
_EVENT = _descriptor.Descriptor(
  name='Event',
  full_name='bloombox.schema.analytics.generic.Event',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='payload', full_name='bloombox.schema.analytics.generic.Event.payload', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='occurred', full_name='bloombox.schema.analytics.generic.Event.occurred', index=1,
