...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_pb=_b('\n\x1bproducts/menu/Section.proto\x12\x15products.menu.section\x1a\x12\x63ontent/Name.proto\x1a\x15media/MediaItem.proto\"S\n\rCustomSection\x12\n\n\x02id\x18\x01 \x01(\t\x12\x36\n\x06\x66ilter\x18\x02 \x01(\x0e\x32&.products.menu.section.FilteredSection\"A\n\x0cSectionMedia\x12\x31\n\x17tablet_homescreen_media\x18\x02 \x01(\x0b\x32\x10.media.MediaItem\"b\n\x0fSectionSettings\x12\x1b\n\x04name\x18\x01 \x01(\x0b\x32\r.content.Name\x12\x32\n\x05media\x18\x02 \x01(\x0b\x32#.products.menu.section.SectionMedia\"\x85\x02\n\x0bSectionSpec\x12\x31\n\x07section\x18\x01 \x01(\x0e\x32\x1e.products.menu.section.SectionH\x00\x12>\n\x0e\x63ustom_section\x18\x02 \x01(\x0b\x32$.products.menu.section.CustomSectionH\x00\x12\x0e\n\x04name\x18\x03 \x01(\tH\x00\x12\x38\n\x08settings\x18\x04 \x01(\x0b\x32&.products.menu.section.SectionSettings\x12\x31\n\x05\x66lags\x18\x05 \x03(\x0e\x32\".products.menu.section.SectionFlagB\x06\n\x04spec*\'\n\x0bSectionFlag\x12\n\n\x06HIDDEN\x10\x00\x12\x0c\n\x08\x46\x45\x41TURED\x10\x01*\x8d\x01\n\x07Section\x12\x0f\n\x0bUNSPECIFIED\x10\x00\x12\x0b\n\x07\x46LOWERS\x10\x01\x12\x0c\n\x08\x45XTRACTS\x10\x02\x12\x0b\n\x07\x45\x44IBLES\x10\x03\x12\x0e\n\nCARTRIDGES\x10\x04\x12\x0e\n\nAPOTHECARY\x10\x05\x12\x0c\n\x08PREROLLS\x10\x06\x12\n\n\x06PLANTS\x10\x07\x12\x0f\n\x0bMERCHANDISE\x10\x08*2\n\x0f\x46ilteredSection\x12\x0b\n\x07ON_SALE\x10\x00\x12\t\n\x05HOUSE\x10\x01\x12\x07\n\x03\x43\x42\x44\x10\x02\x42%\n\x1fio.bloombox.schema.menu.sectionH\x01P\x01\x62\x06proto3')
  ,
  dependencies=[content_dot_Name__pb2.DESCRIPTOR,media_dot_MediaItem__pb2.DESCRIPTOR,])

_SECTIONFLAG = _descriptor.EnumDescriptor(
  name='SectionFlag',
  full_name='products.menu.section.SectionFlag',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_SECTION = _descriptor.EnumDescriptor(
  name='Section',
  full_name='products.menu.section.Section',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_FILTEREDSECTION = _descriptor.EnumDescriptor(
  ...
  full_name='products.menu.section.FilteredSection',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_CUSTOMSECTION = _descriptor.Descriptor(
  name='CustomSection',
  full_name='products.menu.section.CustomSection',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='products.menu.section.CustomSection.id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='filter', full_name='products.menu.section.CustomSection.filter', index=1,
...
_SECTIONMEDIA = _descriptor.Descriptor(
  name='SectionMedia',
  full_name='products.menu.section.SectionMedia',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='tablet_homescreen_media', full_name='products.menu.section.SectionMedia.tablet_homescreen_media', index=0,
...
_SECTIONSETTINGS = _descriptor.Descriptor(
  ...
  full_name='products.menu.section.SectionSettings',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='products.menu.section.SectionSettings.name', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='media', full_name='products.menu.section.SectionSettings.media', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SECTIONSPEC = _descriptor.Descriptor(
  name='SectionSpec',
  full_name='products.menu.section.SectionSpec',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='section', full_name='products.menu.section.SectionSpec.section', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='custom_section', full_name='products.menu.section.SectionSpec.custom_section', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='name', full_name='products.menu.section.SectionSpec.name', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='settings', full_name='products.menu.section.SectionSpec.settings', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='flags', full_name='products.menu.section.SectionSpec.flags', index=4,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='spec', full_name='products.menu.section.SectionSpec.spec',
...
SectionSettings = _reflection.GeneratedProtocolMessageType('SectionSettings', (_message.Message,), dict(
  ...
  __module__ = 'products.menu.Section_pb2'
  # @@protoc_insertion_point(class_scope:products.menu.section.SectionSettings)
  ))
...
SectionSpec = _reflection.GeneratedProtocolMessageType('SectionSpec', (_message.Message,), dict(
  ...
  __module__ = 'products.menu.Section_pb2'
  # @@protoc_insertion_point(class_scope:products.menu.section.SectionSpec)
  ))
_sym_db.RegisterMessage(SectionSpec)


DESCRIPTOR.has_options = True
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('\n\037io.bloombox.schema.menu.sectionH\001P\001'))
