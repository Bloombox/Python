...
_PHONENUMBER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='e164', full_name='contact.PhoneNumber.e164', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='validated', full_name='contact.PhoneNumber.validated', index=1,
