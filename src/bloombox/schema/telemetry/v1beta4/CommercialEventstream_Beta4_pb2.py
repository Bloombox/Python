...
_COMMERCIALEVENTTYPE = _descriptor.EnumDescriptor(
  ...
  full_name='bloombox.tables.telemetry.v1beta4.CommercialEventType',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_COMMERCIALSUBJECT = _descriptor.Descriptor(
  ...
  full_name='bloombox.tables.telemetry.v1beta4.CommercialSubject',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='section', full_name='bloombox.tables.telemetry.v1beta4.CommercialSubject.section', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='section_flag', full_name='bloombox.tables.telemetry.v1beta4.CommercialSubject.section_flag', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='product', full_name='bloombox.tables.telemetry.v1beta4.CommercialSubject.product', index=2,
...
_COMMERCIALEVENTS = _descriptor.Descriptor(
  ...
  full_name='bloombox.tables.telemetry.v1beta4.CommercialEvents',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='uuid', full_name='bloombox.tables.telemetry.v1beta4.CommercialEvents.uuid', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='timing', full_name='bloombox.tables.telemetry.v1beta4.CommercialEvents.timing', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='context', full_name='bloombox.tables.telemetry.v1beta4.CommercialEvents.context', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='actors', full_name='bloombox.tables.telemetry.v1beta4.CommercialEvents.actors', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='type', full_name='bloombox.tables.telemetry.v1beta4.CommercialEvents.type', index=4,
...
_ORDERS = _descriptor.Descriptor(
  name='Orders',
  full_name='bloombox.tables.telemetry.v1beta4.Orders',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='bloombox.tables.telemetry.v1beta4.Orders.id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='session', full_name='bloombox.tables.telemetry.v1beta4.Orders.session', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='stats', full_name='bloombox.tables.telemetry.v1beta4.Orders.stats', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='order', full_name='bloombox.tables.telemetry.v1beta4.Orders.order', index=3,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
CommercialSubject = _reflection.GeneratedProtocolMessageType('CommercialSubject', (_message.Message,), dict(
  ...
  __module__ = 'telemetry.v1beta4.CommercialEventstream_Beta4_pb2'
  # @@protoc_insertion_point(class_scope:bloombox.tables.telemetry.v1beta4.CommercialSubject)
  ))
...
CommercialEvents = _reflection.GeneratedProtocolMessageType('CommercialEvents', (_message.Message,), dict(
  ...
  __module__ = 'telemetry.v1beta4.CommercialEventstream_Beta4_pb2'
  # @@protoc_insertion_point(class_scope:bloombox.tables.telemetry.v1beta4.CommercialEvents)
  ))
...
Orders = _reflection.GeneratedProtocolMessageType('Orders', (_message.Message,), dict(
  DESCRIPTOR = _ORDERS,
  __module__ = 'telemetry.v1beta4.CommercialEventstream_Beta4_pb2'
  # @@protoc_insertion_point(class_scope:bloombox.tables.telemetry.v1beta4.Orders)
  ))
_sym_db.RegisterMessage(Orders)


DESCRIPTOR.has_options = True
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('\n+io.bloombox.schema.tables.telemetry.v1beta4B\033CommercialEventstream_Beta4H\001P\000\370\001\001'))
