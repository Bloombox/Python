...
def add_EventTelemetryServicer_to_server(servicer, server):
  ...
  generic_handler = grpc.method_handlers_generic_handler(
      'services.telemetry.v1beta3.EventTelemetry', rpc_method_handlers)
...
def add_CommercialTelemetryServicer_to_server(servicer, server):
  ...
  generic_handler = grpc.method_handlers_generic_handler(
      'services.telemetry.v1beta3.CommercialTelemetry', rpc_method_handlers)
  server.add_generic_rpc_handlers((generic_handler,))
...
def add_IdentityTelemetryServicer_to_server(servicer, server):
  ...
  generic_handler = grpc.method_handlers_generic_handler(
      'services.telemetry.v1beta3.IdentityTelemetry', rpc_method_handlers)
  server.add_generic_rpc_handlers((generic_handler,))
