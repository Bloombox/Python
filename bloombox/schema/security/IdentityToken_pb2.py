...
_IDENTITYTOKEN = _descriptor.Descriptor(
  name='IdentityToken',
  full_name='security.IdentityToken',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='uid', full_name='security.IdentityToken.uid', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='encoded', full_name='security.IdentityToken.encoded', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='issuer', full_name='security.IdentityToken.issuer', index=2,
