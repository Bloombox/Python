...
_OSTYPE = _descriptor.EnumDescriptor(
  name='OSType',
  full_name='bloombox.schema.analytics.context.OSType',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_DEVICEOS = _descriptor.Descriptor(
  name='DeviceOS',
  full_name='bloombox.schema.analytics.context.DeviceOS',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='type', full_name='bloombox.schema.analytics.context.DeviceOS.type', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='version', full_name='bloombox.schema.analytics.context.DeviceOS.version', index=1,
