...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_pb=_b('\n$structs/pricing/SaleDescriptor.proto\x12\x0fstructs.pricing\x1a\x16temporal/Instant.proto\"&\n\x12PercentageDiscount\x12\x10\n\x08\x64iscount\x18\x14 \x01(\r\"/\n\x0c\x42OGODiscount\x12\x0f\n\x07trigger\x18\x15 \x01(\r\x12\x0e\n\x06reward\x18\x16 \x01(\r\"2\n\x0fLoyaltyDiscount\x12\x0f\n\x07trigger\x18\x17 \x01(\r\x12\x0e\n\x06reward\x18\x18 \x01(\r\"\xb1\x02\n\x0eSaleDescriptor\x12\'\n\x04type\x18\x01 \x01(\x0e\x32\x19.structs.pricing.SaleType\x12$\n\teffective\x18\x02 \x01(\x0b\x32\x11.temporal.Instant\x12%\n\nexpiration\x18\x03 \x01(\x0b\x32\x11.temporal.Instant\x12=\n\x0epercentage_off\x18\x04 \x01(\x0b\x32#.structs.pricing.PercentageDiscountH\x00\x12-\n\x04\x62ogo\x18\x05 \x01(\x0b\x32\x1d.structs.pricing.BOGODiscountH\x00\x12\x33\n\x07loyalty\x18\x06 \x01(\x0b\x32 .structs.pricing.LoyaltyDiscountH\x00\x42\x06\n\x04sale*5\n\x08SaleType\x12\x12\n\x0ePERCENTAGE_OFF\x10\x00\x12\x08\n\x04\x42OGO\x10\x01\x12\x0b\n\x07LOYALTY\x10\x02\x42;\n!io.bloombox.schema.product.structB\x0fProductDiscountH\x01P\x01\xf8\x01\x01\x62\x06proto3')
  ,
  dependencies=[temporal_dot_Instant__pb2.DESCRIPTOR,])

_SALETYPE = _descriptor.EnumDescriptor(
  name='SaleType',
  full_name='structs.pricing.SaleType',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_PERCENTAGEDISCOUNT = _descriptor.Descriptor(
  ...
  full_name='structs.pricing.PercentageDiscount',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='discount', full_name='structs.pricing.PercentageDiscount.discount', index=0,
...
_BOGODISCOUNT = _descriptor.Descriptor(
  name='BOGODiscount',
  full_name='structs.pricing.BOGODiscount',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='trigger', full_name='structs.pricing.BOGODiscount.trigger', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='reward', full_name='structs.pricing.BOGODiscount.reward', index=1,
...
_LOYALTYDISCOUNT = _descriptor.Descriptor(
  ...
  full_name='structs.pricing.LoyaltyDiscount',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='trigger', full_name='structs.pricing.LoyaltyDiscount.trigger', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='reward', full_name='structs.pricing.LoyaltyDiscount.reward', index=1,
...
_SALEDESCRIPTOR = _descriptor.Descriptor(
  name='SaleDescriptor',
  full_name='structs.pricing.SaleDescriptor',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='type', full_name='structs.pricing.SaleDescriptor.type', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='effective', full_name='structs.pricing.SaleDescriptor.effective', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='expiration', full_name='structs.pricing.SaleDescriptor.expiration', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='percentage_off', full_name='structs.pricing.SaleDescriptor.percentage_off', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='bogo', full_name='structs.pricing.SaleDescriptor.bogo', index=4,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='loyalty', full_name='structs.pricing.SaleDescriptor.loyalty', index=5,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='sale', full_name='structs.pricing.SaleDescriptor.sale',
...
BOGODiscount = _reflection.GeneratedProtocolMessageType('BOGODiscount', (_message.Message,), dict(
  ...
  __module__ = 'structs.pricing.SaleDescriptor_pb2'
  # @@protoc_insertion_point(class_scope:structs.pricing.BOGODiscount)
  ))
