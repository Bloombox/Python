...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_pb=_b('\n\x1cpos/v1beta1/POSService.proto\x12\x14services.pos.v1beta1\x1a\x1cservices/ServiceStatus.proto\x1a\x1cgoogle/api/annotations.proto\"\xbf\x01\n\x04Ping\x1a\t\n\x07Request\x1a\x33\n\x08Response\x12\'\n\x06status\x18\x01 \x01(\x0e\x32\x17.services.ServiceStatus\x1aw\n\tOperation\x12\x33\n\x07request\x18\x01 \x01(\x0b\x32\".services.pos.v1beta1.Ping.Request\x12\x35\n\x08response\x18\x02 \x01(\x0b\x32#.services.pos.v1beta1.Ping.Response*\xb2\x01\n\x08POSError\x12\x0b\n\x07UNKNOWN\x10\x00\x12\x16\n\x12INVALID_COLLECTION\x10\x01\x12\x13\n\x0fINVALID_PARTNER\x10\x02\x12\x14\n\x10INVALID_LOCATION\x10\x03\x12\x12\n\x0eINVALID_DEVICE\x10\x04\x12\x15\n\x11PARTNER_NOT_FOUND\x10\x05\x12\x16\n\x12LOCATION_NOT_FOUND\x10\x06\x12\x13\n\x0fINVALID_PAYLOAD\x10\x63\x32u\n\x0bPointOfSale\x12\x66\n\x04Ping\x12\".services.pos.v1beta1.Ping.Request\x1a#.services.pos.v1beta1.Ping.Response\"\x15\x82\xd3\xe4\x93\x02\x0f\x12\r/v1beta1/pingB-\n\'io.bloombox.schema.services.pos.v1beta1H\x01P\x01\x62\x06proto3')
  ,
...
_POSERROR = _descriptor.EnumDescriptor(
  name='POSError',
  full_name='services.pos.v1beta1.POSError',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_PING_REQUEST = _descriptor.Descriptor(
  name='Request',
  full_name='services.pos.v1beta1.Ping.Request',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_PING_RESPONSE = _descriptor.Descriptor(
  name='Response',
  full_name='services.pos.v1beta1.Ping.Response',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='status', full_name='services.pos.v1beta1.Ping.Response.status', index=0,
...
_PING_OPERATION = _descriptor.Descriptor(
  name='Operation',
  full_name='services.pos.v1beta1.Ping.Operation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='request', full_name='services.pos.v1beta1.Ping.Operation.request', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='response', full_name='services.pos.v1beta1.Ping.Operation.response', index=1,
...
_PING = _descriptor.Descriptor(
  name='Ping',
  full_name='services.pos.v1beta1.Ping',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_POINTOFSALE = _descriptor.ServiceDescriptor(
  name='PointOfSale',
  full_name='services.pos.v1beta1.PointOfSale',
  file=DESCRIPTOR,
  index=0,
  options=None,
  ...
  _descriptor.MethodDescriptor(
    name='Ping',
    full_name='services.pos.v1beta1.PointOfSale.Ping',
    index=0,
