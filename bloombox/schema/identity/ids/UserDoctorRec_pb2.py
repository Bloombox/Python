...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_pb=_b('\n identity/ids/UserDoctorRec.proto\x12\x0cidentity.ids\x1a\x0e\x62q_field.proto\x1a\x11geo/USState.proto\x1a\x13person/Person.proto\x1a\x13temporal/Date.proto\"\xb2\x03\n\rUserDoctorRec\x12%\n\x02id\x18\x01 \x01(\tB\x19\x8a@\x16ID number/unique code.\x12S\n\x0f\x65xpiration_date\x18\x02 \x01(\x0b\x32\x0e.temporal.DateB*\x8a@\'Expiration date for the recommendation.\x12&\n\x07\x62\x61rcode\x18\x03 \x01(\tB\x15\x8a@\x12Raw barcode value.\x12O\n\x05state\x18\x04 \x01(\x0e\x32\x10.geo.usa.USStateB.\x8a@+US state where the recommendation is valid.\x12\x33\n\x07\x63ountry\x18\x05 \x01(\tB\"\x8a@\x1f\x43ountry for the recommendation.\x12)\n\tdoctor_id\x18\x06 \x01(\tB\x16\x8a@\x13\x44octor\'s unique ID.\x12L\n\x06\x64octor\x18\x07 \x01(\x0b\x32\x0e.person.PersonB,\x8a@)Personal information about the physician.B%\n\x1fio.bloombox.schema.identity.idsH\x01P\x01\x62\x06proto3')
  ,
...
_USERDOCTORREC = _descriptor.Descriptor(
  name='UserDoctorRec',
  full_name='identity.ids.UserDoctorRec',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='identity.ids.UserDoctorRec.id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='expiration_date', full_name='identity.ids.UserDoctorRec.expiration_date', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='barcode', full_name='identity.ids.UserDoctorRec.barcode', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='state', full_name='identity.ids.UserDoctorRec.state', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='country', full_name='identity.ids.UserDoctorRec.country', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='doctor_id', full_name='identity.ids.UserDoctorRec.doctor_id', index=5,
    ...
    _descriptor.FieldDescriptor(
      name='doctor', full_name='identity.ids.UserDoctorRec.doctor', index=6,
