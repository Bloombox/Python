...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_pb=_b('\n\"structs/labtesting/TestValue.proto\x12\x12structs.labtesting\x1a\x15media/MediaItem.proto\"o\n\tTestValue\x12/\n\x04type\x18\x01 \x01(\x0e\x32!.structs.labtesting.TestValueType\x12\x15\n\x0bmeasurement\x18\n \x01(\x01H\x00\x12\x11\n\x07present\x18\x14 \x01(\x08H\x00\x42\x07\n\x05value\"b\n\tTestMedia\x12/\n\x04type\x18\x01 \x01(\x0e\x32!.structs.labtesting.TestMediaType\x12$\n\nmedia_item\x18\x02 \x01(\x0b\x32\x10.media.MediaItem*=\n\rTestValueType\x12\x0e\n\nMILLIGRAMS\x10\x00\x12\x0e\n\nPERCENTAGE\x10\x01\x12\x0c\n\x08PRESENCE\x10\x03*@\n\rTestMediaType\x12\x0f\n\x0b\x43\x45RTIFICATE\x10\x00\x12\x0b\n\x07RESULTS\x10\x01\x12\x11\n\rPRODUCT_IMAGE\x10\x02\x42\x43\n)io.bloombox.schema.product.struct.testingB\x0f\x42\x61seTestingSpecH\x01P\x01\xf8\x01\x01\x62\x06proto3')
  ,
  dependencies=[media_dot_MediaItem__pb2.DESCRIPTOR,])

_TESTVALUETYPE = _descriptor.EnumDescriptor(
  name='TestValueType',
  full_name='structs.labtesting.TestValueType',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_TESTMEDIATYPE = _descriptor.EnumDescriptor(
  name='TestMediaType',
  full_name='structs.labtesting.TestMediaType',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_TESTVALUE = _descriptor.Descriptor(
  name='TestValue',
  full_name='structs.labtesting.TestValue',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='type', full_name='structs.labtesting.TestValue.type', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='measurement', full_name='structs.labtesting.TestValue.measurement', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='present', full_name='structs.labtesting.TestValue.present', index=2,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='value', full_name='structs.labtesting.TestValue.value',
...
_TESTMEDIA = _descriptor.Descriptor(
  name='TestMedia',
  full_name='structs.labtesting.TestMedia',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='type', full_name='structs.labtesting.TestMedia.type', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='media_item', full_name='structs.labtesting.TestMedia.media_item', index=1,
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('\n)io.bloombox.schema.product.struct.testingB\017BaseTestingSpecH\001P\001\370\001\001'))
