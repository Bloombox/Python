...
_DEVICE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='uuid', full_name='device.Device.uuid', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='flags', full_name='device.Device.flags', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='key', full_name='device.Device.key', index=3,
...
_DEVICEFLAGS = _descriptor.Descriptor(
  name='DeviceFlags',
  full_name='device.DeviceFlags',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='ephemeral', full_name='device.DeviceFlags.ephemeral', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='managed', full_name='device.DeviceFlags.managed', index=1,
...
_DEVICECREDENTIALS = _descriptor.Descriptor(
  ...
  full_name='device.DeviceCredentials',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='public_key', full_name='device.DeviceCredentials.public_key', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='private_key', full_name='device.DeviceCredentials.private_key', index=1,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\200@\001')), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='sha256', full_name='device.DeviceCredentials.sha256', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='identity', full_name='device.DeviceCredentials.identity', index=3,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\200@\001')), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='authorities', full_name='device.DeviceCredentials.authorities', index=4,
...
DeviceFlags = _reflection.GeneratedProtocolMessageType('DeviceFlags', (_message.Message,), dict(
  ...
  __module__ = 'device.Device_pb2'
  # @@protoc_insertion_point(class_scope:device.DeviceFlags)
  ))
