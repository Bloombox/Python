...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='services.checkin.v1beta1',
  syntax='proto3',
  serialized_pb=_b('\n*checkin/v1beta1/CheckinService_Beta1.proto\x12\x18services.checkin.v1beta1\x1a\x13identity/User.proto\x1a\x1cservices/ServiceStatus.proto\x1a\x17person/PersonName.proto\x1a\x1cgoogle/api/annotations.proto\"\xc7\x01\n\x04Ping\x1a\t\n\x07Request\x1a\x33\n\x08Response\x12\'\n\x06status\x18\x01 \x01(\x0e\x32\x17.services.ServiceStatus\x1a\x7f\n\tOperation\x12\x37\n\x07request\x18\x01 \x01(\x0b\x32&.services.checkin.v1beta1.Ping.Request\x12\x39\n\x08response\x18\x02 \x01(\x0b\x32\'.services.checkin.v1beta1.Ping.Response\"m\n\x0b\x43heckinUser\x12\x1e\n\x03key\x18\x01 \x01(\x0b\x32\x11.identity.UserKey\x12\"\n\x05\x66lags\x18\x02 \x01(\x0b\x32\x13.identity.UserFlags\x12\x1a\n\x04name\x18\x03 \x01(\x0b\x32\x0c.person.Name\"!\n\x11\x43heckinEnrollment\x12\x0c\n\x04\x63ode\x18\x01 \x01(\t\"\xe4\x01\n\x0f\x43heckinResponse\x12\x0f\n\x07success\x18\x01 \x01(\x08\x12\x13\n\x0bmust_enroll\x18\x02 \x01(\x08\x12\x35\n\x05\x65rror\x18\x03 \x01(\x0e\x32&.services.checkin.v1beta1.CheckinError\x12\x33\n\x04user\x18\x04 \x01(\x0b\x32%.services.checkin.v1beta1.CheckinUser\x12?\n\nenrollment\x18\x05 \x01(\x0b\x32+.services.checkin.v1beta1.CheckinEnrollment\"\xe7\x01\n\tIDCheckin\x1aQ\n\x07Request\x12\x0b\n\x03raw\x18\x01 \x01(\t\x12\r\n\x05scope\x18\x02 \x01(\t\x12\x15\n\rserial_number\x18\x03 \x01(\t\x12\x13\n\x0b\x66ingerprint\x18\x04 \x01(\t\x1a\x86\x01\n\tOperation\x12<\n\x07request\x18\x01 \x01(\x0b\x32+.services.checkin.v1beta1.IDCheckin.Request\x12;\n\x08response\x18\x02 \x01(\x0b\x32).services.checkin.v1beta1.CheckinResponse\"\xf7\x01\n\x0b\x43\x61rdCheckin\x1a]\n\x07Request\x12\x10\n\x08\x63\x61rdType\x18\x01 \x01(\t\x12\x0f\n\x07payload\x18\x02 \x01(\t\x12\x11\n\tsignature\x18\x03 \x01(\t\x12\r\n\x05\x61gent\x18\x04 \x01(\t\x12\r\n\x05scope\x18\x05 \x01(\t\x1a\x88\x01\n\tOperation\x12>\n\x07request\x18\x01 \x01(\x0b\x32-.services.checkin.v1beta1.CardCheckin.Request\x12;\n\x08response\x18\x02 \x01(\x0b\x32).services.checkin.v1beta1.CheckinResponse*\xc5\x02\n\x0c\x43heckinError\x12\x0c\n\x08NO_ERROR\x10\x00\x12\x10\n\x0cID_NOT_FOUND\x10\x01\x12\x0e\n\nID_EXPIRED\x10\x02\x12\x0e\n\nID_INVALID\x10\x03\x12\x17\n\x13ID_TYPE_UNSUPPORTED\x10\x04\x12\x15\n\x11\x43\x41RD_TYPE_INVALID\x10\x05\x12\x10\n\x0c\x43\x41RD_EXPIRED\x10\x06\x12\x12\n\x0e\x43\x41RD_SUSPENDED\x10\x07\x12\x12\n\x0eUSER_SUSPENDED\x10\x08\x12\x15\n\x11PARTNER_SUSPENDED\x10\t\x12\x13\n\x0fPARTNER_INVALID\x10\n\x12\x14\n\x10LOCATION_INVALID\x10\x0b\x12\x18\n\x14JURISDICTION_INVALID\x10\x0c\x12\x1c\n\x18JURISDICTION_UNSUPPORTED\x10\r\x12\x11\n\rUSER_UNDERAGE\x10\x0e\x32\xdf\x03\n\x07\x43heckin\x12v\n\x04Ping\x12&.services.checkin.v1beta1.Ping.Request\x1a\'.services.checkin.v1beta1.Ping.Response\"\x1d\x82\xd3\xe4\x93\x02\x17\x12\x15/checkin/v1beta1/ping\x12\xcf\x01\n\x0eIdentification\x12+.services.checkin.v1beta1.IDCheckin.Request\x1a).services.checkin.v1beta1.CheckinResponse\"e\x82\xd3\xe4\x93\x02_\"9/checkin/v1beta1/{scope=partners/*/locations/*}/global:id:\x01*Z\x1f\"\x1a/checkin/v1beta1/global:id:\x01*\x12\x89\x01\n\x04\x43\x61rd\x12-.services.checkin.v1beta1.CardCheckin.Request\x1a).services.checkin.v1beta1.CheckinResponse\"\'\x82\xd3\xe4\x93\x02!\"\x1c/checkin/v1beta1/global:card:\x01*B1\n+io.bloombox.schema.services.checkin.v1beta1H\x01P\x01\x62\x06proto3')
  ,
...
_CHECKINERROR = _descriptor.EnumDescriptor(
  name='CheckinError',
  full_name='services.checkin.v1beta1.CheckinError',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_PING_REQUEST = _descriptor.Descriptor(
  name='Request',
  full_name='services.checkin.v1beta1.Ping.Request',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_PING_RESPONSE = _descriptor.Descriptor(
  name='Response',
  full_name='services.checkin.v1beta1.Ping.Response',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='status', full_name='services.checkin.v1beta1.Ping.Response.status', index=0,
...
_PING_OPERATION = _descriptor.Descriptor(
  name='Operation',
  full_name='services.checkin.v1beta1.Ping.Operation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='request', full_name='services.checkin.v1beta1.Ping.Operation.request', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='response', full_name='services.checkin.v1beta1.Ping.Operation.response', index=1,
...
_PING = _descriptor.Descriptor(
  name='Ping',
  full_name='services.checkin.v1beta1.Ping',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_CHECKINUSER = _descriptor.Descriptor(
  name='CheckinUser',
  full_name='services.checkin.v1beta1.CheckinUser',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='services.checkin.v1beta1.CheckinUser.key', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='flags', full_name='services.checkin.v1beta1.CheckinUser.flags', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='name', full_name='services.checkin.v1beta1.CheckinUser.name', index=2,
...
_CHECKINENROLLMENT = _descriptor.Descriptor(
  ...
  full_name='services.checkin.v1beta1.CheckinEnrollment',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='code', full_name='services.checkin.v1beta1.CheckinEnrollment.code', index=0,
...
_CHECKINRESPONSE = _descriptor.Descriptor(
  ...
  full_name='services.checkin.v1beta1.CheckinResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='success', full_name='services.checkin.v1beta1.CheckinResponse.success', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='must_enroll', full_name='services.checkin.v1beta1.CheckinResponse.must_enroll', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='error', full_name='services.checkin.v1beta1.CheckinResponse.error', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='user', full_name='services.checkin.v1beta1.CheckinResponse.user', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='enrollment', full_name='services.checkin.v1beta1.CheckinResponse.enrollment', index=4,
...
_IDCHECKIN_REQUEST = _descriptor.Descriptor(
  name='Request',
  full_name='services.checkin.v1beta1.IDCheckin.Request',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='raw', full_name='services.checkin.v1beta1.IDCheckin.Request.raw', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='scope', full_name='services.checkin.v1beta1.IDCheckin.Request.scope', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='serial_number', full_name='services.checkin.v1beta1.IDCheckin.Request.serial_number', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='fingerprint', full_name='services.checkin.v1beta1.IDCheckin.Request.fingerprint', index=3,
...
_IDCHECKIN_OPERATION = _descriptor.Descriptor(
  name='Operation',
  full_name='services.checkin.v1beta1.IDCheckin.Operation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='request', full_name='services.checkin.v1beta1.IDCheckin.Operation.request', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='response', full_name='services.checkin.v1beta1.IDCheckin.Operation.response', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_IDCHECKIN = _descriptor.Descriptor(
  name='IDCheckin',
  full_name='services.checkin.v1beta1.IDCheckin',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_CARDCHECKIN_REQUEST = _descriptor.Descriptor(
  name='Request',
  full_name='services.checkin.v1beta1.CardCheckin.Request',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='cardType', full_name='services.checkin.v1beta1.CardCheckin.Request.cardType', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='payload', full_name='services.checkin.v1beta1.CardCheckin.Request.payload', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='signature', full_name='services.checkin.v1beta1.CardCheckin.Request.signature', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='agent', full_name='services.checkin.v1beta1.CardCheckin.Request.agent', index=3,
      number=4, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='scope', full_name='services.checkin.v1beta1.CardCheckin.Request.scope', index=4,
...
_CARDCHECKIN_OPERATION = _descriptor.Descriptor(
  name='Operation',
  full_name='services.checkin.v1beta1.CardCheckin.Operation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='request', full_name='services.checkin.v1beta1.CardCheckin.Operation.request', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='response', full_name='services.checkin.v1beta1.CardCheckin.Operation.response', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CARDCHECKIN = _descriptor.Descriptor(
  name='CardCheckin',
  full_name='services.checkin.v1beta1.CardCheckin',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
Ping = _reflection.GeneratedProtocolMessageType('Ping', (_message.Message,), dict(
  ...
  Request = _reflection.GeneratedProtocolMessageType('Request', (_message.Message,), dict(
    ...
    # @@protoc_insertion_point(class_scope:services.checkin.v1beta1.Ping.Request)
    ))
  ,
  ...
  Response = _reflection.GeneratedProtocolMessageType('Response', (_message.Message,), dict(
    ...
    __module__ = 'checkin.v1beta1.CheckinService_Beta1_pb2'
    # @@protoc_insertion_point(class_scope:services.checkin.v1beta1.Ping.Response)
    ))
  ,
  ...
  Operation = _reflection.GeneratedProtocolMessageType('Operation', (_message.Message,), dict(
    ...
    __module__ = 'checkin.v1beta1.CheckinService_Beta1_pb2'
    # @@protoc_insertion_point(class_scope:services.checkin.v1beta1.Ping.Operation)
    ))
  ,
  DESCRIPTOR = _PING,
  __module__ = 'checkin.v1beta1.CheckinService_Beta1_pb2'
  # @@protoc_insertion_point(class_scope:services.checkin.v1beta1.Ping)
  ))
...
_CHECKIN = _descriptor.ServiceDescriptor(
  name='Checkin',
  full_name='services.checkin.v1beta1.Checkin',
  file=DESCRIPTOR,
  index=0,
  options=None,
  ...
  _descriptor.MethodDescriptor(
    name='Ping',
    full_name='services.checkin.v1beta1.Checkin.Ping',
    index=0,
  ...
  _descriptor.MethodDescriptor(
    name='Identification',
    full_name='services.checkin.v1beta1.Checkin.Identification',
    index=1,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    name='Card',
    full_name='services.checkin.v1beta1.Checkin.Card',
    index=2,
    containing_service=None,
