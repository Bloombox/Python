...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='partner',
  syntax='proto3',
  serialized_pb=_b('\n\x15partner/Partner.proto\x12\x07partner\x1a\x0e\x62q_field.proto\x1a\x15media/MediaItem.proto\x1a\x16temporal/Instant.proto\x1a\x19\x63ontact/ContactInfo.proto\"\\\n\nPartnerKey\x12N\n\x04\x63ode\x18\x01 \x01(\tB@\x8a@=Short string that uniquely identifies a partner organization.\"\x96\x06\n\x07Partner\x12Q\n\x04\x63ode\x18\x01 \x01(\tBC\x8a@@Short string that uniquely identifies this partner organization.\x12I\n\x04name\x18\x02 \x01(\tB;\x8a@8Full human-readable label for this partner organization.\x12]\n\x05\x66lags\x18\x03 \x01(\x0b\x32\x15.partner.PartnerFlagsB7\x8a@4Flags for various things about this partner account.\x12>\n\nlegal_name\x18\x04 \x01(\tB*\x8a@\'Legal name of the partner organization.\x12T\n\x07\x63ontact\x18\x05 \x01(\x0b\x32\x14.contact.ContactInfoB-\x8a@*Contact information for this organization.\x12R\n\x08\x62randing\x18\x06 \x01(\x0b\x32\x10.media.MediaItemB.\x8a@+Branding information for this organization.\x12u\n\x07\x63hannel\x18\x07 \x01(\x0e\x32\x17.partner.PartnerChannelBK\x8a@HChannel through which this partner organization interacts with Bloombox.\x12R\n\x07\x63reated\x18\x64 \x01(\x0b\x32\x11.temporal.InstantB.\x8a@+Timestamp for when this record was created.\x12Y\n\x08modified\x18\x65 \x01(\x0b\x32\x11.temporal.InstantB4\x8a@1Timestamp for when this record was last modified.\"\xde\x05\n\x0cPartnerFlags\x12\xa2\x01\n\tsuspended\x18\x01 \x01(\x08\x42\x8e\x01\x8a@\x8a\x01Specifies that the subject partner organization is currently suspended, organization wide, and has had access revoked to Bloombox systems.\x12\xb0\x01\n\x07pastdue\x18\x02 \x01(\x08\x42\x9e\x01\x8a@\x9a\x01Specifies that the subject partner organiztaion is currently in a past-due state, where their organization and related access has been heavily restricted.\x12t\n\x04\x62\x65ta\x18\x03 \x01(\x08\x42\x66\x8a@cSpecifies that the subject partner organization has access to beta features, clusters, and systems.\x12`\n\x07sandbox\x18\x04 \x01(\x08\x42O\x8a@LSpecifies that the subject partner organization has internal sandbox access.\x12\x9d\x01\n\x08internal\x18\x05 \x01(\x08\x42\x8a\x01\x8a@\x86\x01Specifies that the subject partner organization is a testing account held and managed internally by Bloombox, or by selected partners.*\x1c\n\x0ePartnerChannel\x12\n\n\x06\x44IRECT\x10\x00\x42 \n\x1aio.bloombox.schema.partnerH\x01P\x01\x62\x06proto3')
  ,
...
_PARTNERCHANNEL = _descriptor.EnumDescriptor(
  name='PartnerChannel',
  full_name='partner.PartnerChannel',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_PARTNERKEY = _descriptor.Descriptor(
  name='PartnerKey',
  full_name='partner.PartnerKey',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='code', full_name='partner.PartnerKey.code', index=0,
...
_PARTNER = _descriptor.Descriptor(
  name='Partner',
  full_name='partner.Partner',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='code', full_name='partner.Partner.code', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='name', full_name='partner.Partner.name', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='flags', full_name='partner.Partner.flags', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='legal_name', full_name='partner.Partner.legal_name', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='contact', full_name='partner.Partner.contact', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='branding', full_name='partner.Partner.branding', index=5,
    ...
    _descriptor.FieldDescriptor(
      name='channel', full_name='partner.Partner.channel', index=6,
    ...
    _descriptor.FieldDescriptor(
      name='created', full_name='partner.Partner.created', index=7,
    ...
    _descriptor.FieldDescriptor(
      name='modified', full_name='partner.Partner.modified', index=8,
...
_PARTNERFLAGS = _descriptor.Descriptor(
  name='PartnerFlags',
  full_name='partner.PartnerFlags',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='suspended', full_name='partner.PartnerFlags.suspended', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='pastdue', full_name='partner.PartnerFlags.pastdue', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='beta', full_name='partner.PartnerFlags.beta', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='sandbox', full_name='partner.PartnerFlags.sandbox', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='internal', full_name='partner.PartnerFlags.internal', index=4,
