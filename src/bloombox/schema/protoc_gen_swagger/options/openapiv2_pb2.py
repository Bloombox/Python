...
_SWAGGER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='security_definitions', full_name='grpc.gateway.protoc_gen_swagger.options.Swagger.security_definitions', index=7,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='security', full_name='grpc.gateway.protoc_gen_swagger.options.Swagger.security', index=8,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='external_docs', full_name='grpc.gateway.protoc_gen_swagger.options.Swagger.external_docs', index=9,
...
_OPERATION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='security', full_name='grpc.gateway.protoc_gen_swagger.options.Operation.security', index=9,
      number=12, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SECURITYDEFINITIONS_SECURITYENTRY.has_options = True
_SECURITYDEFINITIONS_SECURITYENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
_SECURITYREQUIREMENT_SECURITYREQUIREMENTENTRY.has_options = True
_SECURITYREQUIREMENT_SECURITYREQUIREMENTENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
_SCOPES_SCOPEENTRY.has_options = True
_SCOPES_SCOPEENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
