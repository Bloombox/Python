...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='media',
  syntax='proto3',
  serialized_pb=_b('\n\x15media/MediaItem.proto\x12\x05media\x1a\x0e\x62q_field.proto\x1a\x14media/MediaKey.proto\x1a\x15media/MediaType.proto\"\xfa\x01\n\tMediaItem\x12J\n\x03key\x18\x01 \x01(\x0b\x32\x0f.media.MediaKeyB,\x8a@)Key uniquely identifying this media item.\x12\x44\n\x04type\x18\x02 \x01(\x0b\x32\x10.media.MediaTypeB$\x8a@!Type of media this is describing.\x12.\n\x04name\x18\x03 \x01(\tB \x8a@\x1d\x46riendly name for this media.\x12+\n\x03uri\x18\x04 \x01(\tB\x1e\x8a@\x1b\x41\x62solute URI to this media.B0\n\x18io.bloombox.schema.mediaB\rAttachedMediaH\x01P\x01\xf8\x01\x01\x62\x06proto3')
  ,
...
_MEDIAITEM = _descriptor.Descriptor(
  name='MediaItem',
  full_name='media.MediaItem',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='media.MediaItem.key', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='type', full_name='media.MediaItem.type', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='name', full_name='media.MediaItem.name', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='uri', full_name='media.MediaItem.uri', index=3,
