...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_pb=_b('\n#analytics/context/Application.proto\x12!bloombox.schema.analytics.context\x1a\x0e\x62q_field.proto\x1a\x15structs/Version.proto\"\xf7\x02\n\x0eWebApplication\x12=\n\x06origin\x18\x01 \x01(\tB-\x8a@*Specifies an origin for a web application.\x12P\n\x08location\x18\x02 \x01(\tB>\x8a@;Full, absolute URL the user was at when the event was sent.\x12-\n\x06\x61nchor\x18\x03 \x01(\tB\x1d\x8a@\x1a\x41nchor in the URL, if any.\x12/\n\x05title\x18\x04 \x01(\tB \x8a@\x1dTitle of the current webpage.\x12\x34\n\x08referrer\x18\x05 \x01(\tB\"\x8a@\x1fReferring URL for this webpage.\x12>\n\x08protocol\x18\x06 \x01(\tB,\x8a@)Protocol that was used to serve this URL.\"\x8b\x04\n\x11\x44\x65viceApplication\x12\\\n\x04type\x18\x01 \x01(\x0e\x32\x32.bloombox.schema.analytics.context.ApplicationTypeB\x1a\xf0?\x01\x8a@\x14Type of application.\x12]\n\x07version\x18\x02 \x01(\x0b\x32!.opencannabis.structs.VersionSpecB)\x8a@&Version for the reporting application.\x12\x8f\x01\n\x03web\x18\n \x01(\x0b\x32\x31.bloombox.schema.analytics.context.WebApplicationBM\x8a@JSpecifies information about an event that was sent from a web application.H\x00\x12\x45\n\tbundle_id\x18\x14 \x01(\tB0\x8a@-Specifies a bundle ID for an iOS application.H\x00\x12X\n\x12\x61ndroid_package_id\x18\x1e \x01(\tB:\x8a@7Specifies an application ID for an Android application.H\x00\x42\x06\n\x04spec*,\n\x0f\x41pplicationType\x12\x0c\n\x08INTERNAL\x10\x00\x12\x0b\n\x07PARTNER\x10\x01\x42\x44\n$io.bloombox.schema.telemetry.contextB\x12\x41pplicationContextH\x01P\x00\xa2\x02\x03\x42\x42Sb\x06proto3')
  ,
...
_APPLICATIONTYPE = _descriptor.EnumDescriptor(
  ...
  full_name='bloombox.schema.analytics.context.ApplicationType',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_WEBAPPLICATION = _descriptor.Descriptor(
  name='WebApplication',
  full_name='bloombox.schema.analytics.context.WebApplication',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='origin', full_name='bloombox.schema.analytics.context.WebApplication.origin', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='location', full_name='bloombox.schema.analytics.context.WebApplication.location', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='anchor', full_name='bloombox.schema.analytics.context.WebApplication.anchor', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='title', full_name='bloombox.schema.analytics.context.WebApplication.title', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='referrer', full_name='bloombox.schema.analytics.context.WebApplication.referrer', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='protocol', full_name='bloombox.schema.analytics.context.WebApplication.protocol', index=5,
...
_DEVICEAPPLICATION = _descriptor.Descriptor(
  ...
  full_name='bloombox.schema.analytics.context.DeviceApplication',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='type', full_name='bloombox.schema.analytics.context.DeviceApplication.type', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='version', full_name='bloombox.schema.analytics.context.DeviceApplication.version', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='web', full_name='bloombox.schema.analytics.context.DeviceApplication.web', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='bundle_id', full_name='bloombox.schema.analytics.context.DeviceApplication.bundle_id', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='android_package_id', full_name='bloombox.schema.analytics.context.DeviceApplication.android_package_id', index=4,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='spec', full_name='bloombox.schema.analytics.context.DeviceApplication.spec',
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('\n$io.bloombox.schema.telemetry.contextB\022ApplicationContextH\001P\000\242\002\003BBS'))
