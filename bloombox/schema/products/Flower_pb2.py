...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='products',
  syntax='proto3',
  serialized_pb=_b('\n\x15products/Flower.proto\x12\x08products\x1a\x15\x62\x61se/ProductKey.proto\x1a\x1b\x63ontent/MaterialsData.proto\x1a\x1c\x63ontent/ProductContent.proto\"{\n\x06\x46lower\x12\x1d\n\x03key\x18\x01 \x01(\x0b\x32\x10.base.ProductKey\x12(\n\x07product\x18\x02 \x01(\x0b\x32\x17.content.ProductContent\x12(\n\x08material\x18\x03 \x01(\x0b\x32\x16.content.MaterialsDataB2\n\x1aio.bloombox.schema.productB\rFlowerProductH\x01P\x00\xf8\x01\x01\x62\x06proto3')
  ,
...
_FLOWER = _descriptor.Descriptor(
  name='Flower',
  full_name='products.Flower',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='products.Flower.key', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='product', full_name='products.Flower.product', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='material', full_name='products.Flower.material', index=2,
...
Flower = _reflection.GeneratedProtocolMessageType('Flower', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:products.Flower)
  ))
