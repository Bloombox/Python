...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='services.menu.v1beta1',
  syntax='proto3',
  serialized_pb=_b('\n$menu/v1beta1/MenuService_Beta1.proto\x12\x15services.menu.v1beta1\x1a\x18products/menu/Menu.proto\x1a\x1bproducts/menu/Section.proto\x1a\x1cservices/ServiceStatus.proto\x1a\x1cgoogle/api/annotations.proto\"\xc1\x01\n\x04Ping\x1a\t\n\x07Request\x1a\x33\n\x08Response\x12\'\n\x06status\x18\x01 \x01(\x0e\x32\x17.services.ServiceStatus\x1ay\n\tOperation\x12\x34\n\x07request\x18\x01 \x01(\x0b\x32#.services.menu.v1beta1.Ping.Request\x12\x36\n\x08response\x18\x02 \x01(\x0b\x32$.services.menu.v1beta1.Ping.Response\"\xde\x01\n\x07GetMenu\x1a\x91\x01\n\x07Request\x12\r\n\x05scope\x18\x01 \x01(\t\x12\x0c\n\x04\x66ull\x18\x02 \x01(\x08\x12\x11\n\tkeys_only\x18\x03 \x01(\x08\x12\x10\n\x08snapshot\x18\x04 \x01(\t\x12\x13\n\x0b\x66ingerprint\x18\x05 \x01(\t\x12/\n\x07section\x18\x06 \x01(\x0e\x32\x1e.products.menu.section.Section\x1a?\n\x08Response\x12$\n\x07\x63\x61talog\x18\x01 \x01(\x0b\x32\x13.products.menu.Menu\x12\r\n\x05\x63ount\x18\x02 \x01(\x05*\x98\x01\n\tMenuError\x12\x0c\n\x08NO_ERROR\x10\x00\x12\x13\n\x0fPARTNER_INVALID\x10\x01\x12\x14\n\x10LOCATION_INVALID\x10\x02\x12\x13\n\x0fSECTION_INVALID\x10\x03\x12\x15\n\x11SECTION_NOT_FOUND\x10\x04\x12\x12\n\x0eMENU_NOT_FOUND\x10\x05\x12\x12\n\x0eINTERNAL_ERROR\x10\x06\x32\xde\x02\n\x04Menu\x12m\n\x04Ping\x12#.services.menu.v1beta1.Ping.Request\x1a$.services.menu.v1beta1.Ping.Response\"\x1a\x82\xd3\xe4\x93\x02\x14\x12\x12/menu/v1beta1/ping\x12\xe6\x01\n\x08Retrieve\x12&.services.menu.v1beta1.GetMenu.Request\x1a\'.services.menu.v1beta1.GetMenu.Response\"\x88\x01\x82\xd3\xe4\x93\x02\x81\x01\x12</menu/v1beta1/{scope=partners/*/locations/*}/global:retrieveZA\x12?/menu/v1beta1/{scope=partners/*/locations/*}/{section}:retrieveB.\n(io.bloombox.schema.services.menu.v1beta1H\x01P\x01\x62\x06proto3')
  ,
...
_MENUERROR = _descriptor.EnumDescriptor(
  name='MenuError',
  full_name='services.menu.v1beta1.MenuError',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_PING_REQUEST = _descriptor.Descriptor(
  name='Request',
  full_name='services.menu.v1beta1.Ping.Request',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_PING_RESPONSE = _descriptor.Descriptor(
  name='Response',
  full_name='services.menu.v1beta1.Ping.Response',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='status', full_name='services.menu.v1beta1.Ping.Response.status', index=0,
...
_PING_OPERATION = _descriptor.Descriptor(
  name='Operation',
  full_name='services.menu.v1beta1.Ping.Operation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='request', full_name='services.menu.v1beta1.Ping.Operation.request', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='response', full_name='services.menu.v1beta1.Ping.Operation.response', index=1,
...
_PING = _descriptor.Descriptor(
  name='Ping',
  full_name='services.menu.v1beta1.Ping',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_GETMENU_REQUEST = _descriptor.Descriptor(
  name='Request',
  full_name='services.menu.v1beta1.GetMenu.Request',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='scope', full_name='services.menu.v1beta1.GetMenu.Request.scope', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='full', full_name='services.menu.v1beta1.GetMenu.Request.full', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='keys_only', full_name='services.menu.v1beta1.GetMenu.Request.keys_only', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='snapshot', full_name='services.menu.v1beta1.GetMenu.Request.snapshot', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='fingerprint', full_name='services.menu.v1beta1.GetMenu.Request.fingerprint', index=4,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='section', full_name='services.menu.v1beta1.GetMenu.Request.section', index=5,
...
_GETMENU_RESPONSE = _descriptor.Descriptor(
  name='Response',
  full_name='services.menu.v1beta1.GetMenu.Response',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='catalog', full_name='services.menu.v1beta1.GetMenu.Response.catalog', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='count', full_name='services.menu.v1beta1.GetMenu.Response.count', index=1,
...
_GETMENU = _descriptor.Descriptor(
  name='GetMenu',
  full_name='services.menu.v1beta1.GetMenu',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
Ping = _reflection.GeneratedProtocolMessageType('Ping', (_message.Message,), dict(
  ...
  Request = _reflection.GeneratedProtocolMessageType('Request', (_message.Message,), dict(
    ...
    # @@protoc_insertion_point(class_scope:services.menu.v1beta1.Ping.Request)
    ))
  ,
  ...
  Response = _reflection.GeneratedProtocolMessageType('Response', (_message.Message,), dict(
    ...
    __module__ = 'menu.v1beta1.MenuService_Beta1_pb2'
    # @@protoc_insertion_point(class_scope:services.menu.v1beta1.Ping.Response)
    ))
  ,
  ...
  Operation = _reflection.GeneratedProtocolMessageType('Operation', (_message.Message,), dict(
    ...
    __module__ = 'menu.v1beta1.MenuService_Beta1_pb2'
    # @@protoc_insertion_point(class_scope:services.menu.v1beta1.Ping.Operation)
    ))
  ,
  DESCRIPTOR = _PING,
  __module__ = 'menu.v1beta1.MenuService_Beta1_pb2'
  # @@protoc_insertion_point(class_scope:services.menu.v1beta1.Ping)
  ))
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('\n(io.bloombox.schema.services.menu.v1beta1H\001P\001'))

_MENU = _descriptor.ServiceDescriptor(
  name='Menu',
  full_name='services.menu.v1beta1.Menu',
  file=DESCRIPTOR,
  index=0,
  options=None,
  ...
  _descriptor.MethodDescriptor(
    name='Ping',
    full_name='services.menu.v1beta1.Menu.Ping',
    index=0,
  ...
  _descriptor.MethodDescriptor(
    name='Retrieve',
    full_name='services.menu.v1beta1.Menu.Retrieve',
    index=1,
    containing_service=None,
